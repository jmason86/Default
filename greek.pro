...
;
;       NO_APPEND_FONT - Set to prevent append the characters specifying a
...
;       windt@bell-labs.com
;   James Mason 2012/9/14: default to append_font instead of the reverse
;                    
;-

function greek,input,plain=plain,force_ps=force_ps,no_append_font=no_append_font

IF keyword_set(no_append_font) THEN append_font = 0 ELSE append_font = 1
