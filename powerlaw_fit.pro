...
;
; PURPOSE:
;   Fit a power law to data. Based on https://people.ok.ubc.ca/erosolo/idl/lib/powerlaw_fit.pro. 
;
; INPUTS:
;
;
...
;   2015/06/16: James Paul Mason: Wrote script.
;-
FUNCTION JPMFitPowerLaw, inputX, inputY, errors = errors, sigma = sigma, guess = guess, chisq = chisq

fitCoefficients = powerlaw_fit(inputX, inputY, guess = guess, covar = covar, errors = errors)
